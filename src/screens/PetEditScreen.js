...
import { getPetDetails, updatePet } from "../actions/petActions";
import Aos from "aos";
...
function PetEditScreen() {
  ...
  }, [pet, id, successUpdate, navigate, userInfo]);
  const lahoreAreas = [
    "Amin Park",
    "Alpha Co Operative",
  ...
  const submitHandler = (e) => {
    ...
    console.log(id);
    console.log(pet._id);
    dispatch(updatePet({ _id: pet._id, area, email, tag, phone }));
